...
Utilisation d'un `ConstrainLayout` afin de pouvoir centrer horizontalement et verticalement dans 
le parent.
...
| Test effectué                        | Résultat attendu                                              | Résultat obtenu |
|--------------------------------------|---------------------------------------------------------------|-----------------|
| Ouvrir l'application                 | Affichage des deux fragments (CounterFragment et ColorFragment) | OK              |
| Incrémenter le compteur              | Le compteur augmente de 1                                     | OK              |
| Rotation de l'écran                  | Les états des fragments sont restaurés                        | OK              |
| Modifier la couleur                  | La couleur de fond change selon les curseurs                 | OK              |
| Rotation après modification couleur  | La couleur est restaurée correctement                         | OK              |
